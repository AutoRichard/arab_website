...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ \"lodash\");\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../helpers/dbErrorHandler */ \"./server/helpers/dbErrorHandler.js\");\n/* harmony import */ var _models_forum_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/forum.model */ \"./server/models/forum.model.js\");\n\n\n\n\n/*\r\nfunction paginate(pageNumber, nPerPage){\r\n    db.forum.find().skip((pageNumber-1)*nPerPage).limit(nPerPage)\r\n}\r\n*/\n\n//creat: title, text, category, postedBy(userId), --comment-- \nconst create = (req, res, next) => {\n\n    var forumModel = new _models_forum_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"](req.body);\n\n    forumModel.save(function (err) {\n        if (err) {\n            return res.status(500).json({\n                error: 'Forum Creation Failed'\n            });\n        } else {\n            return res.status(200).json({\n                message: 'Forum Created'\n            });\n        }\n    });\n};\n\n//list all forum\nconst list = (req, res) => {\n\n    _models_forum_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].find((err, forum) => {\n        if (err) {\n            return res.status(400).json({\n                error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n            });\n        }\n        res.json(forum);\n    }).populate('postedBy', '_id name').select('title text postedBy category');\n};\n\n//return specific forum\nconst forumByID = (req, res, next, id) => {\n    _models_forum_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].findById(id).populate('postedBy', '_id name').exec((err, forum) => {\n        if (err || !forum) return res.status('400').json({\n            error: \"Forum not found\"\n        });\n        req.details = forum;\n        next();\n    });\n};\n\n//update: title, text, category, postedBy(userId)\nconst update = (req, res, next) => {\n    let forum = req.details;\n    forum = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.extend(forum, req.body);\n    forum.updated = Date.now();\n    forum.save((err, result) => {\n        if (err) {\n            return res.status(400).json({\n                error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n            });\n        }\n        res.json(forum);\n    });\n};\n\n//return specific forum\nconst read = (req, res) => {\n    return res.json(req.details);\n};\n\n//extension from blogId\nconst remove = (req, res, next) => {\n    let forum = req.details;\n    forum.remove((err, deletedForum) => {\n        if (err) {\n            return res.status(400).json({\n                error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n            });\n        }\n        res.json(deletedForum);\n    });\n};\n\n//list all category\nconst listCategory = (req, res) => {\n    _models_forum_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].distinct('category', {}, (err, forum) => {\n        if (err) {\n            return res.status(400).json({\n                error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n            });\n        }\n        res.json(forum);\n    });\n};\n\n//forum by category {category}\nconst listForumByCategory = (req, res) => {\n    _models_forum_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].find({ \"category\": req.body.category }).populate('postedBy', '_id name').populate('comments.postedBy', '_id name').populate('comments.replyComment.postedBy', '_id name').exec((err, result) => {\n        if (err) {\n            return res.status(400).json({\n                error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n            });\n        }\n        res.json(result);\n    });\n};\n\n//forum by  user {userId}\nconst listForumByUser = (req, res) => {\n    _models_forum_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].find({ \"postedBy\": req.body.userId }).populate('postedBy', '_id name').populate('comments.postedBy', '_id name').populate('comments.replyComment.postedBy', '_id name').exec((err, result) => {\n        if (err) {\n            return res.status(400).json({\n                error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n            });\n        }\n        res.json(result);\n    });\n};\n\n//comment, userId, forumId\nconst _postMessage = (req, res) => {\n\n    let comment = {};\n    comment.text = req.body.comment;\n    comment.postedBy = req.body.userId;\n\n    _models_forum_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].findByIdAndUpdate(req.body.forumId, { $push: { comments: comment } }, { new: true }).populate('comments.postedBy', '_id name').populate('postedBy', '_id name').exec((err, result) => {\n        if (err) {\n            return res.status(400).json({\n                error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n            });\n        }\n        res.json(result);\n    });\n};\n\n//commentId and blogId\nconst _deleteMessage = (req, res) => {\n    let commentId = req.body.commentId;\n\n    _models_forum_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].findByIdAndUpdate(req.body.blogId, { $pull: { comments: { _id: commentId } } }, { new: true }).exec((err, result) => {\n        if (err) {\n            return res.status(400).json({\n                error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n            });\n        }\n        res.json(result);\n    });\n};\n\n//commentId, userId, comment\nconst _replyMessage = (req, res) => {\n    let comment = {};\n    comment.text = req.body.comment;\n    comment.postedBy = req.body.userId;\n\n    _models_forum_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].findOneAndUpdate({ \"comments._id\": req.body.commentId }, { $push: { \"comments.$.replyComment\": comment } }, { safe: true, upsert: true, new: true }).populate('comments.replyComment.postedBy', '_id name').populate('comments.postedBy', '_id name').populate('postedBy', '_id name').exec((err, result) => {\n        if (err) {\n            return res.status(400).json({\n                error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n            });\n        }\n        res.json(result);\n    });\n};\n\n//replycommentId\nconst _replyDeleteMessage = (req, res) => {\n    let replycommentId = req.body.replyId;\n\n    _models_forum_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].findOneAndUpdate({ \"comments.replyComment._id\": replycommentId }, { $pull: { \"comments.$.replyComment\": { _id: replycommentId } } }, { safe: true, upsert: true, new: true }).exec((err, result) => {\n        if (err) {\n            return res.status(400).json({\n                error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n            });\n        }\n        res.json(result);\n    });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n    create, list, forumByID, update, read, remove, _postMessage, _deleteMessage, _replyMessage, _replyDeleteMessage, listCategory, listForumByCategory, listForumByUser\n});\n\n//# sourceURL=webpack:///./server/controllers/forum.controller.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../controllers/auth.controller */ \"./server/controllers/auth.controller.js\");\n/* harmony import */ var _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/blog.controller */ \"./server/controllers/blog.controller.js\");\n\n\n\n\nconst router = express__WEBPACK_IMPORTED_MODULE_0___default.a.Router();\n\n//craete and list blog\nrouter.route('/api/blog').get(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].list).post(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].create);\n\n//single blog, update, and delete\nrouter.route('/api/blog/:blogId').get(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].read).put(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].update).delete(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].remove);\n\n//comment to a single blog and delete\nrouter.route('/api/comment').put(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"]._postComment).delete(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"]._deleteComment);\n\n//reply to comment on single blog and delete\nrouter.route('/api/replycomment').put(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"]._replyComment).delete(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"]._replyDeleteComment);\n\n//find specific blog photo\nrouter.route('/api/blogPhoto/:blogId').get(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].photo);\n\n//find specific blog\nrouter.param('blogId', _controllers_blog_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].blogByID);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (router);\n\n//# sourceURL=webpack:///./server/routes/blog.route.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../controllers/auth.controller */ \"./server/controllers/auth.controller.js\");\n/* harmony import */ var _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/forum.controller */ \"./server/controllers/forum.controller.js\");\n\n\n\n\nconst router = express__WEBPACK_IMPORTED_MODULE_0___default.a.Router();\n\n//create new forum and list all\nrouter.route('/api/forum').get(_controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].list).post(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].create);\n\n//read specific forum, update and delete\nrouter.route('/api/forum/:forumId').get(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].read).put(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].update).delete(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].remove);\n\n//comment and delete comment\nrouter.route('/api/message').put(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"]._postMessage).delete(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"]._deleteMessage);\n\n//reply to a specific comment and delete reply\nrouter.route('/api/replymessage').put(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"]._replyMessage).delete(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"]._replyDeleteMessage);\n\n//return all category\nrouter.route('/api/categories').get(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].listCategory);\n\n//return based on category\nrouter.route('/api/category').post(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].listForumByCategory);\n\nrouter.route('/api/userForum').post(_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requireSignin, _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasAuthorization, _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].listForumByUser);\n\n//fetch specific forum\nrouter.param('forumId', _controllers_forum_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].forumByID);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (router);\n\n//# sourceURL=webpack:///./server/routes/forum.route.js?");
